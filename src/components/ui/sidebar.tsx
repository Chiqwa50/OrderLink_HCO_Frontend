...
export function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "absolute end-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-semibold tabular-nums text-sidebar-foreground select-none pointer-events-none",
