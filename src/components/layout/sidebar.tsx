...
import { getNavigationsByRole } from "@/data/navigations"
...
export function Sidebar() {
  ...
  // الحصول على القائمة المناسبة حسب دور المستخدم
  const navigationsData = getNavigationsByRole(user?.role || "DEPARTMENT")
  ...
  return (
    <SidebarWrapper side={settings.locale === "ar" ? "right" : "left"}>
      <SidebarHeader>
        <Link
          href="/"
        ...
        >
          <Image
            src="/images/icons/OrderLink.svg"
            alt=""
            height={20}
            width={20}
